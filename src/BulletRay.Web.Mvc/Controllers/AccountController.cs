...
using BulletRay.Identity;
using BulletRay.MultiTenancy;
using BulletRay.Sessions;
using BulletRay.Web.Models.Account;
using BulletRay.Web.Views.Shared.Components.TenantChange;

namespace BulletRay.Web.Controllers
{
    public class AccountController : BulletRayControllerBase
    {
