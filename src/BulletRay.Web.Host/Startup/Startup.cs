...
namespace BulletRay.Web.Host.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "BulletRay API", Version = "v1" });
            ...
            return services.AddAbp<BulletRayWebHostModule>(
        ...
        {
            app.Properties["host.AppName"] = "BulletRay";
